...
class MTP(BaseObject):  # nocov
    ...
    class DcOptions(BaseObject):
        ...
        def __init__(self, enviroment: MTP.Environment) -> None:
            ...
            self._data: typing.Dict[
                DcId, typing.List[MTP.DcOptions.Endpoint]
            ] = {}
        ...
        def constructFromBuiltIn(self) -> None:
            ...
            if self.isTestMode():
                addToData(
                    BuiltInDc.kBuiltInDcsTest, MTP.DcOptions.Flag.f_static | 0
                )  # type: ignore
                addToData(
                ...
                addToData(
                    BuiltInDc.kBuiltInDcs, MTP.DcOptions.Flag.f_static | 0
                )  # type: ignore
                addToData(
    ...
    class Config(BaseObject):
        ...
        def endpoints(
            ...
            for endpoint in endpoints:
                if dcId == 0 or endpoint.id == dcId:
                    ...
                    address = (
                        Address.IPv6 if (flags & Flag.f_ipv6) else Address.IPv4
                    )
        ...
        def FromSerialized(serialized: QByteArray) -> MTP.Config:
            ...
            fileds.pinnedDialogsInFolderMax = read(
                fileds.pinnedDialogsInFolderMax
            )
            fileds.internalLinksDomain = read(fileds.internalLinksDomain)
            fileds.channelsReadMediaPeriod = read(
                fileds.channelsReadMediaPeriod
            )
