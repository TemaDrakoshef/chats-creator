...
class APIData(object, metaclass=BaseAPIMetaClass):
    ...
    def __init__(
        ...
        Expects(
            ...
            or (api_id != None and api_hash != None),
        ...
        self.system_version = (
            system_version if system_version else cls.system_version
        )
    ...
    def Generate(cls: Type[_T], unique_id: str = None) -> _T:
        ...
        return cls(
            device_model=deviceInfo.model, system_version=deviceInfo.version
        )
...
class API(BaseObject):
    ...
    class TelegramDesktop(APIData):
        ...
        @classmethod
        def Generate(
            cls: Type[_T], system: str = "macos", unique_id: str = None
        ) -> _T:
            pass
        ...
        @classmethod
        def Generate(
            cls: Type[_T], system: str = "linux", unique_id: str = None
        ) -> _T:
            pass
        ...
        @classmethod
        def Generate(
            cls: Type[_T], system: str = None, unique_id: str = None
        ) -> _T:
    ...
    class TelegramWeb_Z(APIData):
        ...
        system_lang_code = "en-US"
        lang_pack = (
            ""  # I don"t understand why Telegram Z doesn"t use langPack
        )
